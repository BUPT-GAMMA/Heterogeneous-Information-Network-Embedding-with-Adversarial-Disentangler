...
from evaluate.Aminer_evaluate import Aminer_evaluation
...
mp_1_data = LoadDataset('Aminer', data_root, mp = mp_1)
mp_2_data = LoadDataset('Aminer', data_root, mp = mp_2)
...
while global_step < trainer['total_step']:
	...
	# # 								'MP2 Specific Embedding':mp2_spc_NMI}, epoch)
